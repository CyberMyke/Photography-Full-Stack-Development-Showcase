...
export const PostLayout: Model = {
    ...
    label: 'Post',
    labelField: 'title',
    filePath: 'content/pages/Photography/{slug}.md',
    fieldGroups: [
        {
            name: 'thumbnail',
            label: 'Thumbnail',
    ...
    fields: [
        {
            ...
            label: 'Title',
            required: true,
            default: 'This is a Photography post title',
            hidden: false,
            localized: false
        },
        ...
        },
        {
            type: 'boolean',
            name: 'isFeatured',
            label: 'Exclude from Photography feed',
            description:
                "Enable this option to avoid a featured post (in a 'Featured posts' section) to appear duplicated in the Photography page.",
            required: false,
            default: false,
            hidden: false,
            localized: false,
